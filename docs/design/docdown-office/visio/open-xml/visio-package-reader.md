...
extractor's self-test reads the embedded probe drawing, and the test fixtures build packages with `VisioPackageBuilder` in the test project for it to read
back.

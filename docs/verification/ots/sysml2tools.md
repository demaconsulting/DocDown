...
`SysML2Tools_DocDownCoreViewSvg`), before Pandoc compiles `docs/design/*.md`, which embed
...
**Requirement coverage**: `DocDown-OTS-SysML2Tools-Lint`.
...
**Requirement coverage**: `DocDown-OTS-SysML2Tools-Render`.
...
- **`DocDown-OTS-SysML2Tools-Lint`**: SysML2Tools_LintSelfTest
- **`DocDown-OTS-SysML2Tools-Render`**: SysML2Tools_RenderSvgSelfTest,
  SysML2Tools_SoftwareStructureViewSvg, SysML2Tools_DocDownCoreViewSvg

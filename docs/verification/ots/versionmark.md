...
**Requirement coverage**: `DocDown-OTS-VersionMark`.
...
**Requirement coverage**: `DocDown-OTS-VersionMark-Lint`.
...
- **`DocDown-OTS-VersionMark`**: VersionMark_CapturesVersions, VersionMark_GeneratesMarkdownReport
- **`DocDown-OTS-VersionMark-Lint`**: VersionMark_LintPassesForValidConfig,
  VersionMark_LintReportsErrorsForInvalidConfig
